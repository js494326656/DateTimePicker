...
public class DateTimePicker extends FrameLayout {
    ...
    public interface OnDateChangedListener {
        void onDateChanged(DateTimePicker view, int year, int monthOfYear,
    ...
    public DateTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.datetime_picker_holo, this, true);
...
//                    DateUtils.LENGTH_SHORTEST);
    ...
    public void updateDate(int year, int month, int dayOfMonth, int hourOfDay,int minute) {
    ...
    private void setDate(int year, int month, int dayOfMonth, int hourOfDay,int minute) {
        mCurrentDate.set(year, month, dayOfMonth, hourOfDay, minute);
        if (mCurrentDate.before(mMinDate)) {
            mCurrentDate.setTimeInMillis(mMinDate.getTimeInMillis());
    ...
    /**
     * @return The selected minute of day.
     */
